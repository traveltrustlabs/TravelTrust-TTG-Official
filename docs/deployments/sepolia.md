# Sepolia · V9 Periphery Governance Upgrade (TESTNET)
...
> Sepolia also uses a **12h** Timelock, on a **different chain and address** than Mainnet Official NEW 12h (`0xF61880fe…`).  
