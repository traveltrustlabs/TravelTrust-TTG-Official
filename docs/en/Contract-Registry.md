...
**ACTIVE registry includes NEW + KEEP only.** Legacy addresses are listed exclusively under [Legacy Policy](Legacy-Policy.md) and **must not** be treated as Official V9 ACTIVE roots.
