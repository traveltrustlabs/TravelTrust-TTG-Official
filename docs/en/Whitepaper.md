...
**Facts:** TravelTrust Web3 发布说明 **V2** · Official www `https://www.web3-ttg.com`  
**Mainnet:** contracts deployed · conversion not open · traveler App in development · **≠** Fully Active · **≠** `TT_PRODUCTION_GO`

These markdown files are the living public whitepaper body for addresses, 25T, and the five-round calendar. They match Official www facts. **PDF twins were regenerated 2026-09-15 from this markdown** (same V2 addresses / calendar). **Not** a prospectus.
